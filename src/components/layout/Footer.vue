    ...
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        <div class="col-span-1 md:col-span-2">
          <h3 class="text-xl font-semibold mb-4">
            SalomeTechRD</h3>
          <p class="text-gray-300 mb-4">Capacitación de alta calidad para educadores comprometidos con la excelencia docente.</p>
        ...
        <div>
          ...
          <ul class="space-y-2 text-gray-300">
            ...
            <li class="flex items-start">
              ...
              <span>contacto@SalomeTechRD.com</span>
            </li>
            <li class="flex items-start">
              <svg class="h-6 w-6 mr-2 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
              </svg>
              <span>+1 809 902 1252</span>
            </li>
          </ul>
        </div>
      </div>
      <div class="mt-8 pt-8 border-t border-gray-700">
        <p class="text-gray-400 text-sm text-center">
          &copy; {{ new Date().getFullYear() }}  SalomeTechRD. Todos los derechos reservados.
        </p>
      </div>
    </div>
  </footer>
